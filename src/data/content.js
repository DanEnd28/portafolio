...
export const PROFILES = {
  ia: {
    ...
    services: [
      { icon: '⚙️', title: 'Automatización de procesos', desc: 'Elimino el trabajo manual y repetitivo de tu equipo con flujos en n8n — desde tareas simples hasta arquitecturas con colas, reintentos y manejo de errores tipado.', tag: 'n8n · Webhooks · Redis' },
      { icon: '🤖', title: 'Agentes conversacionales', desc: 'Atiendo a tus clientes 24/7 en WhatsApp, Instagram, Telegram y voz (Retell AI), con memoria, tool calling y respuestas que no alucinan.', tag: 'WhatsApp · Voz · Telegram' },
      { icon: '🧩', title: 'Resiliencia y manejo de errores', desc: 'Te entrego sistemas que siguen funcionando cuando algo falla: clasificación de errores, reintentos con backoff + jitter y diagnóstico por causa raíz antes de que te enteres tú.', tag: 'Retry · Backoff · RCA' },
      { icon: '🔌', title: 'Integraciones API y CRM', desc: 'Conecto tu CRM, calendario y bases de datos para que la información fluya sola: GoHighLevel, Google Calendar, Supabase y PostgreSQL.', tag: 'GoHighLevel · Supabase' },
      { icon: '⚛️', title: 'Dashboards en React', desc: 'Te doy visibilidad en tiempo real de tus automatizaciones con paneles que consumen y muestran esa data al instante.', tag: 'React · Realtime' },
    ],
  },
  ...
  frontend: {
    ...
    services: [
      { icon: '🎨', title: 'Interfaces de usuario', desc: 'Te doy una interfaz que tus usuarios pueden usar sin fricción: componentes reutilizables, responsive y accesibles con React + Tailwind.', tag: 'React · Tailwind' },
      { icon: '📊', title: 'Dashboards en tiempo real', desc: 'Paneles que muestran tu data actualizada al instante, sin que nadie tenga que refrescar la página (Supabase Realtime).', tag: 'React · Supabase' },
      { icon: '🔗', title: 'Consumo de APIs', desc: 'Conecto tu frontend con el backend de tu equipo y mantengo el estado de la app predecible con Redux.', tag: 'REST · Redux' },
      { icon: '🔐', title: 'Autenticación e integraciones', desc: 'Acceso seguro para tus usuarios con login OAuth (Microsoft) y flujos protegidos, con control de versiones ordenado en Git.', tag: 'OAuth · Git' },
      { icon: '⚡', title: 'TypeScript y rendimiento', desc: 'Código mantenible y builds rápidos con Vite, para que el proyecto no se vuelva difícil de tocar con el tiempo.', tag: 'TypeScript · Vite' },
    ],
  },
  ...
  ti: {
    ...
    services: [
      { icon: '🛠️', title: 'Soporte TI e incidencias', desc: 'Resuelvo las incidencias que frenan a tus usuarios, con diagnóstico rápido y soporte directo.', tag: 'Soporte · Diagnóstico' },
      { icon: '🔗', title: 'Integración de sistemas', desc: 'Hago que tus plataformas, APIs, CRM (GoHighLevel) y servicios externos se hablen entre sí sin fricción.', tag: 'APIs · CRM' },
      { icon: '🗄️', title: 'Bases de datos', desc: 'Diseño esquemas relacionales sólidos y fáciles de mantener (PostgreSQL, SQL Server, MySQL).', tag: 'PostgreSQL · SQL Server' },
      { icon: '⚙️', title: 'Automatización de procesos', desc: 'Reduzco el trabajo manual y los errores operativos de tu equipo con flujos en n8n.', tag: 'n8n · Procesos' },
      { icon: '💻', title: 'Sistemas de gestión', desc: 'Construyo sistemas internos a medida — RRHH, seguros, citas, control de asistencia — para que tu operación deje de depender de hojas de cálculo.', tag: 'React · JavaScript' },
    ],
  },
}
...
export const EXPERIENCE = [
  ...
  },
  {
    ...
    period: '2024 – 2025',
    desc: 'Módulo de RRHH para gestión de vacaciones con login vía Microsoft (OAuth), calendario interactivo y notificaciones en tiempo real.',
